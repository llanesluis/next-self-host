...
DOMAIN_NAME="llanesluis.xyz" # replace with your own
EMAIL="luisllaboj@gmail.com" # replace with your own

# Script Vars
REPO_URL="https://github.com/llanesluis/next-self-host.git"
APP_DIR=~/myapp
